...
class IsIntPalindromTest(unittest.TestCase):
    ...
    def test_is_int_palindrom2(self):
        self.assertEqual(True, solution.is_int_palindrom(1233321))

    def test_is_int_palindrom3(self):
        self.assertEqual(True, solution.is_int_palindrom(000000))

    def test_is_int_palindrom4(self):
        self.assertEqual(False, solution.is_int_palindrom(12345666432))
