...
class IsBalanceTest(unittest.TestCase):
    def test_is_number_balanced1(self):
        self.assertEqual(True, solution.is_number_balanced(10001))

    def test_is_number_balanced2(self):
        self.assertEqual(True, solution.is_number_balanced(14332))

    def test_is_number_balanced3(self):
        self.assertEqual(False, solution.is_number_balanced(4859))

    def test_is_number_balanced4(self):
        self.assertEqual(False, solution.is_number_balanced(1231))
