...
class IsDecreasingTest(unittest.TestCase):
    ...
    def test_is_decreasing3(self):
        self.assertEqual(False, solution.is_decreasing([10, 5, 10]))

    def test_is_decreasing4(self):
        self.assertEqual(False, solution.is_decreasing([1, 2, 3, 4]))

    def test_is_decreasing5(self):
        self.assertEqual(True, solution.is_decreasing([2, 2, 2, 2]))
